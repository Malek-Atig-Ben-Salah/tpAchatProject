        ...
        stage('BUILDING IMAGE') {
            steps {
                script{
                    ...
                    sh 'sudo docker image tag $JOB_NAME:v1.$BUILD_ID malekbensalah/$JOB_NAME:v1.$BUILD_ID'
                    sh 'sudo docker image tag $JOB_NAME:v1.$BUILD_ID malekbensalah/$JOB_NAME:latest'
                }
            }
        }
    }
